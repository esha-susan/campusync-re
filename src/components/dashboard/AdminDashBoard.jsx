...
import './Dashboard.css'; // Your unified CSS

const AdminDashboard = ({ onLogout }) => {
  const stats = [ { label: 'Total Users', value: '1,234', icon: '👥', color: '#6a5acd' }, { label: 'Pending Approvals', value: '18', icon: '⏳', color: '#f59e0b' }, { label: 'Active Events', value: '12', icon: '📅', color: '#10b981' }, { label: 'Open Queries', value: '25', icon: '💬', color: '#ef4444' }];
  const pendingApprovals = [ { id: 1, name: 'John Doe', activity: 'Hackathon Winner' }, { id: 2, name: 'Jane Smith', activity: 'Paper Presentation' }];
  const recentUsers = [ { id: 1, initial: 'A', name: 'Alice Brown', role: 'student • CSE', joined: 'Joined 2025-09-28' }, { id: 2, initial: 'B', name: 'Bob Wilson', role: 'faculty • ECE', joined: 'Joined 2025-09-27' }];
  
  // ========================== THIS IS THE ONLY CHANGE ==========================
  const quickActions = [
    // The new link to the Create User page is added here.
    { to: '/admin/users/create', label: 'Create User', icon: '➕' },
    { to: '/admin/users', label: 'Manage Users', icon: '👥' },
    { to: '/calendar/schedule', label: 'Create Event', icon: '📅' },
        ...
        <main className="dashboard-main">
          <div className="dashboard-content">
            <div className="welcome-section">
              <div><h1 className="dashboard-title">Admin Dashboard</h1><p className="dashboard-subtitle">Manage users, approvals, and system settings.</p></div>
            </div>
