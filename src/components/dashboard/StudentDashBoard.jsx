...
import SideBar from '../common/SideBar'; // Corrected case
import './StudentDashBoard.css';

const StudentDashboard = ({ userRole, onLogout }) => {
      ...
      <div className="main-content-wrapper">
        ...
        <main className="page-content">
          <div className="welcome-section">
            ...
            <Link to="/student/assignments" className="btn-primary-link">
                ...
                {upcomingEvents.map(event => (
                  <div key={event.id} className="event-item">
                    ...
                    <div className="event-details">
                      ...
                      <p className="event-time"><span className="time-icon">🕐</span>{event.time}</p>
          ...
          <div className="dashboard-card full-width-card">
            ...
            <div className="quick-actions">
              <Link to="/student/assignments/submit/new" className="action-card">
                <span className="action-icon">📤</span><span className="action-label">Submit Assignment</span>
              </Link>
              <Link to="/student/activities/submit" className="action-card">
                <span className="action-icon">📄</span><span className="action-label">Submit Certificate</span>
              </Link>
              <Link to="/calendar" className="action-card">
                <span className="action-icon">📅</span><span className="action-label">View Calendar</span>
              </Link>
              <Link to="/submit-query" className="action-card">
                <span className="action-icon">💬</span><span className="action-label">Ask Query</span>
              </Link>
            </div>
          </div>
        </main>
